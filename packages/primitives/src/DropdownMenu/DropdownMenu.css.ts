...
export const content = style({
  ...
  fontSize: `var(--ddm-font-size, ${fontSize.sm})`,
...
export const groupTitle = style({
  ...
  fontSize: `var(--ddm-group-title-font-size, ${fontSize.xs})`,
...
export const itemDescription = style({
  marginTop: "1px",
  fontSize: `var(--ddm-item-description-font-size, ${fontSize.xs})`,
